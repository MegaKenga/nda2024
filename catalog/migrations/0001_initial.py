# Generated by Django 4.2.7 on 2024-01-02 19:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product', to='catalog.productgroup', verbose_name='Группа, к которой принадлежит товар')),
            ],
            options={
                'verbose_name': 'Товар',
